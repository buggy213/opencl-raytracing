use raytracing::{accel::bvh2::LinearizedBVHNode, geometry::{Mesh, Vec3, AABB}};
    ...
    loop {
        if node.tri_count > 0 {
            ...
            for i in 0..node.tri_count {
                ...
                let vertex_indices = mesh.tris[tri_idx as usize];
            ...
            let left = &bvh[left_idx];
            let right = &bvh[left_idx + 1];
